...
describe('GET /api/v1/jeu/jouer/:id', () => {
  // plusieurs appels à jouer (pour valider l’aléatoire)
  for (let i = 0; i < 20; i++) {
    it(`devrait répondre 200 pour ${testNom1} avec des valeurs valides (3 dés)`, async () => {
      ...
      // chaque dé ∈ [1,6]  -> borne sup exclusive = 7
  ...
  it(`devrait répondre 404 quand le joueur n'existe pas (${testNom2})`, async () => {
